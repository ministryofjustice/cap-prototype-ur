...
module.exports = __toCommonJS(termsAndConditions_exports);
var import_paths = __toESM(require("../constants/paths"));
var import_sessionHelpers = require("../utils/sessionHelpers");
const termsAndConditionsRoutes = (router) => {
  router.get(import_paths.default.TERMS_AND_CONDITIONS, (request, response) => {
...
var termsAndConditions_default = termsAndConditionsRoutes;
